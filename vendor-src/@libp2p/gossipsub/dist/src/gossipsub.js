...
export class GossipSub extends TypedEventEmitter {
    ...
    [Symbol.toStringTag] = '@libp2p/gossipsub';
    [serviceCapabilities] = [
        '@libp2p/pubsub'
    ];
    [serviceDependencies] = [
    ...
    async createOutboundStream(peerId, connection) {
        ...
        try {
            ...
            const stream = new OutboundStream(rawStream, (e) => { this.log.error('outbound pipe error', e); }, { maxBufferSize: this.opts.maxOutboundBufferSize });
