...
test('git page HTML contains expected repos via curl', { timeout: 30_000, skip: !serverUp }, async () => {
...
test('proxy forwards info/refs via curl', { timeout: 30_000, skip: !serverUp }, async () => {
...
test('shared libp2p-stack module is served via curl', { timeout: 10_000, skip: !serverUp }, async () => {
